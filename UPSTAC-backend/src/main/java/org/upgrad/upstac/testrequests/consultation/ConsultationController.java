...
public class ConsultationController {
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // Implement this method
        User current = userLoggedInService.getLoggedInUser();
        TestRequest newRequest = testRequestUpdateService.assignForConsultation(id,current);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        User current = userLoggedInService.getLoggedInUser();
        TestRequest updatetest = testRequestUpdateService.updateConsultation( id, testResult, current);
